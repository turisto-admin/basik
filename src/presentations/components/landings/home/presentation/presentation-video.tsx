  ...
  return (
    <section className="relative h-[500px] mx-5 md:mx-28 lg:mx-40 mt-15">
      <div className="flex flex-col items-center justify-center">
        ...
        <button
          className={`${spaceGrotesk.className} bg-primary-red active:bg-secondary-red hover:bg-secondary-red transition-all duration-300 transform hover:scale-105 px-8 py-3 rounded-full flex items-center justify-center gap-2 whitespace-nowrap font-medium cursor-pointer w-full md:w-fit mt-6`}
        >
